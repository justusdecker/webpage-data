...
Ich freue mich riesig, die Fertigstellung und Veröffentlichung meines neuesten Projekts bekanntzugeben: den Nokiator Dateikonverter!
...
* Einfache Bedienung: Unterstützt sowohl einzelne Dateien (-s) als auch ganze Ordner (-f) über einfache Befehlszeilenaufrufe.

Modular & Open Source: Eine übersichtliche Batch-Architektur mit speziellen Hilfsskripten für Audio, Video und Bilder.

Dieses Projekt zeigt, wie sich Tools wie Batch-Skripte und FFmpeg zur Lösung konkreter, praktischer Alltagsprobleme einsetzen lassen – selbst in der Welt der "veralteten Technologien".

Erkundet gerne das [GitHub Repository](https://github.com/justusdecker/Nokiator) :D